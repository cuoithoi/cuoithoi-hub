const Languages = {
  ...
  buttonText: {
    ...
    seeBefore: 'Xem trước',
    copylinkFree: `Link chia sẻ\n(Miễn phí, kèm quảng cáo)`,
  ...
  text: {
    ...
    useFreeWithAds: 'Thiệp mời Miễn Phí sẽ hiển thị quảng cáo',
    useActive90day: 'Thiệp mời có hiệu lực trong vòng 90 ngày',
